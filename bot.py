...
REGION_WORDS = [
    "краснодар", "краснодарский край", "кубань", "сочи",
    "анап", "геленджик", "новороссийск", "туапсе",
    "армавир", "ейск", "сириус",
]

JUNK_WORDS = [
    "погода", "туризм", "турист", "пляж", "курортный",
    "афиша", "концерт", "фестиваль", "матч", "футбол",
    "хоккей", "спорт", "гороскоп", "шоу", "звезда", "рецепт",
]
...
Выбери 3–5 действительно важных историй и для каждой сделай отдельный почти готовый текст.
...
Для каждой выбранной новости пиши строго так:

**Заголовок**

Лид 1–2 предложения. В лиде естественно укажи источник: «пишет РБК», «сообщает “Коммерсант”», «по данным 93.RU» и так далее.

Основной текст: 4–8 коротких абзацев. Без канцелярита, без воды, без списков, без нумерации.
...
Не пиши блоки «Источник», «Почему важно», «Черновик», «Что проверить».
Не выдумывай факты. Если данных мало — пиши осторожно.
